    ...
    <>
      <div className="college-bg">
        <div className="college-container">
          ...
          {error && <div className="college-error-message">{error}</div>}
                ...
                <tbody>
                  {colleges.map((college, index) => (
                    <tr key={index} className={getRowClassName(index)}>
                      <td className="college-table-cell college-rank-cell">
                        {index + 1}
                      </td>
                      <td className="college-table-cell college-name-cell">
                        {college.name}
                      </td>
                      <td className="college-table-cell college-cutoff-cell">
                        {college.cutoffs["2025"]}
                      </td>
          ...
          {showGraph && selectedCollege && (
            <div className="college-modal-overlay">
              <div className="college-modal">
                <h2 className="college-modal-title">
                  {selectedCollege.name} - Cutoff Trends
                </h2>
