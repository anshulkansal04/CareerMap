...
const Carousel = () => {
  ...
  return (
    <div className="nep-carousel" id="-policy-insights-">
      <div className="container">
        <h2 className="nep-carousel-title">Policy Insights</h2>
        <Slider {...settings}>
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">New School Structure (5+3+3+4 Model)</h3>
            <p className="nep-carousel-item-content">
          ...
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">Focus on Basic Reading, Writing, and Math Skills</h3>
            <p className="nep-carousel-item-content">
              <strong>Priority on Literacy and Numeracy:</strong> The policy aims to ensure that all students achieve foundational literacy and numeracy by Grade 3, 
              recognizing these skills as essential for all further learning.
              <br /><br />
          ...
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">Learning in Local Languages</h3>
            <p className="nep-carousel-item-content">
          ...
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">More Choices in Higher Education</h3>
            <p className="nep-carousel-item-content">
          ...
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">Skill-Based Learning from a Young Age</h3>
            <p className="nep-carousel-item-content">
          ...
          <div className="nep-carousel-item">
            <h3 className="nep-carousel-item-title">Reformed Assessment System</h3>
            <p className="nep-carousel-item-content">
